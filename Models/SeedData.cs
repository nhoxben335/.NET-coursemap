...
namespace nscccoursemap_nhoxben335.Models
{
    ...
    {        
        ...
        #region SEED SEMESTERS
                    ...
                    context.Semesters.AddRange(
                        ...
                        new Semester { 
                            Name = "Spring 2022", 
                            StartDate = DateTime.Parse("2021-04-25"), 
                            EndDate = DateTime.Parse("2021-05-27"), 
                            AcademicYearId = generatedAcademicYears.Find(ay => ay.Title == "2021-22").Id 
                        }
                    );
                    context.SaveChanges();
        ...
        #region SEED ADVISING ASSIGNMENTS
                    ...
                    context.AdvisingAssignments.AddRange(
                        ...
                        new AdvisingAssignment {
                            ...
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Gillespie").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "O'Connell").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Generalist" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.FirstName == "Paul" && i.LastName == "Street").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Tsaltas").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Mogensen").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "McLeod").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Cyber Security" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Russell").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Generalist" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Caines").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "O'Driscoll").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Dutka").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Cunningham").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Arenburg").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Shewan").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "Computer Electronics Technician" && dys.AcademicYear.Title == "2018-19").Id
                        },
                        #endregion //2018-19
                        ...
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Tsaltas").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Gillespie").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Crocker").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 2" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Russell").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 3" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Mogensen").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Shewan").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.FirstName == "Todd" && i.LastName == "Verge").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.FirstName == "Paul" && i.LastName == "Street").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Cyber Security" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Dolinger").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Business Intelligence Analytics" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "O'Connell").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Generalist" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Caines").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "O'Driscoll").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Dutka").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Cunningham").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Arenburg").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "McLeod").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "Cyber Security" && dys.AcademicYear.Title == "2019-20").Id
                        },
                        #endregion //2019-20
                        ...
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Tsaltas").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Gillespie").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Crocker").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 2" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Mogensen").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Scarfone").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Shewan").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "McLeod").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Cyber Security" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Dolinger").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Business Intelligence Analytics" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.FirstName == "Todd" && i.LastName == "Verge").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Embedded Systems Programming" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Caines").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2020-21").Id
                        },
	                    new AdvisingAssignment {
	                        InstructorId = generatedInstructors.Find(i => i.LastName == "Russell").Id,
	                        DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2020-21").Id
	                    },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Abu Baker").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 2" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Dutka").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Cunningham").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Campanis").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Hinton").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "Cyber Security" && dys.AcademicYear.Title == "2020-21").Id
                        },
                        #endregion //2020-21
                        ...
                        new AdvisingAssignment {
                            ...
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2021-22").Id
                        },
						new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Gillespie").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2021-22").Id
                        },
						new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Crocker").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 2" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Mogensen").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Campanis").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Cunningham").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Hinton").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Cyber Security" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Dolinger").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Business Intelligence Analytics" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.FirstName == "Todd" && i.LastName == "Verge").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Embedded Systems Programming" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Caines").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Web Programming" && dys.AcademicYear.Title == "2021-22").Id
                        },
	                    new AdvisingAssignment {
	                        InstructorId = generatedInstructors.Find(i => i.LastName == "Russell").Id,
	                        DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2021-22").Id
	                    },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Abu Baker").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 2" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Programming" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Dutka").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Systems Management & Security" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Campanis").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Data Analytics" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Cunningham").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "IT - Database Administration" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "McLeod").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 2" && dys.DiplomaYear.Diploma.Title == "Cyber Security" && dys.AcademicYear.Title == "2021-22").Id
                        },
                        new AdvisingAssignment {
                            InstructorId = generatedInstructors.Find(i => i.LastName == "Tsaltas").Id,
                            DiplomaYearSectionId = generatedDiplomaYearSections.Find(dys => dys.Title == "Section 1" && dys.DiplomaYear.Title == "Year 1" && dys.DiplomaYear.Diploma.Title == "Full Stack Application Development" && dys.AcademicYear.Title == "2021-22").Id
                        }
                        #endregion //2020-21
